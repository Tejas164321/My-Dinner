      ...
      <div className="peer-data-[state=collapsed]:[--sidebar-ml:var(--sidebar-width-icon)] peer-data-[state=expanded]:[--sidebar-ml:var(--sidebar-width)] flex-1 flex flex-col transition-all duration-300 ease-in-out md:ml-[--sidebar-ml]">
        <header className="sticky top-0 z-20 flex h-16 shrink-0 items-center justify-between border-b bg-background/80 px-4 backdrop-blur-md sm:px-6">
          <div className="flex items-center gap-2">
            ...
            <div className="group-data-[collapsible=icon]:hidden md:group-data-[collapsible=icon]:flex">
                <Link href={user.role === 'Mess Manager' ? '/admin' : '/student'} className="flex items-center gap-3 font-semibold text-lg">
                    <div className="rounded-lg bg-primary/10 p-2 text-primary">
                        <ChefHat className="h-6 w-6" />
                    </div>
                    <span className="hidden md:group-data-[collapsible=expanded]:hidden">Messo</span>
                </Link>
            </div>
          </div>
